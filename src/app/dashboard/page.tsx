            ...
            {projects.map((project) => (
              <li key={project.id}>
                <Link
                  ...
                  className="block overflow-hidden rounded-xl border border-zinc-200 transition hover:border-zinc-400 hover:bg-zinc-50 dark:border-zinc-800 dark:hover:border-zinc-600 dark:hover:bg-zinc-900"
                >
                  {project.thumbnailPath && project.status === "RENDERED" && (
                    <img
